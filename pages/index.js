    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      h-full m-0 overflow-hidden'>
        <section className=''>
          ...
          <div className='text-center'>
            ...
            <h3 className='text-2xl text-slate-100 pt-2 pb-5 cursor-default select-none dark:text-gaiat-blue duration-300'>Técnico em Informática | Designer</h3>
          </div>
        ...
        <section>
          ...
          <div className="gap-10 justify-evenly items-start lg:flex">
            <div className="text-center bg-slate-900 shadow-slate-500 shadow rounded-xl my-10 mx-2 p-10 hover:scale-105 hover:shadow
              ...
              <Image className='relative mx-auto dark:hidden' src={iconDesign} width={150} height={150} alt='ícone do card de designs' />
              <Image className='relative mx-auto hidden dark:block' src={iconDesignB} width={150} height={150} alt='ícone do card de designs' />
            ...
            <div className="text-center bg-slate-900 shadow-slate-500 shadow rounded-xl my-10 mx-2 p-10 transition-all
              ...
              <Image className='relative mx-auto dark:hidden transition-all duration-300' src={iconFix} width={150} height={150} alt='ícone' />
              <Image className='relative mx-auto hidden dark:block transition-all duration-300' src={iconFixB} width={150} height={150} alt='ícone' />
              <h3 className="text-1xl font-bold pt-6 pb-2 text-slate-50 dark:text-gaiat-blue duration-300">
              ...
              <div className='py-6 w-80 lsm:mx-auto lsm:w-56'>
                <label className='relative'>
                  <input type='email' className='w-80 h-12 px-6 lsm:w-56 text-md outline-none text-white bg-slate-700 border-2 rounded-lg border-white border-opacity-60
                    focus:border-teal-200 transition duration-300' placeholder='Nome' />
                </label>
              </div>
              <div className='py-6 w-80 lsm:mx-auto lsm:w-56'>
                <label className='relative'>
                  <input type='text' className='w-80 h-12 px-6 lsm:w-56 text-md outline-none text-white bg-slate-700 border-2 rounded-lg border-white border-opacity-60
                    focus:border-teal-200 transition duration-300' placeholder='Email' />
                </label>
              </div>
              <div className='py-6 w-80 lsm:mx-auto lsm:w-56'>
                <label className='relative'>
                  <input type='text' className='w-80 h-16 px-6 lsm:w-56 text-md outline-none text-white bg-slate-700 border-2 rounded-lg border-white border-opacity-60
                    focus:border-teal-200 transition duration-300' placeholder='Mensagem' />
                </label>
              </div>
            </div>
          </div>
      ...
      <footer>
        <div className='text-center text-slate-400 bg-slate-900 p-3 cursor-default select-none min-h-fit'>
          <div className='relative rounded-full w-7 h-7 overflow-clip mx-auto border-slate-50 border-2 cursor-pointer' title='Soulzin Dev'>
